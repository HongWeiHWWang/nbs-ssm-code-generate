...
public class CodeGenerateFactory
{
  ...
  public static void codeGenerate(String tableName, String codeName, String entityPackage, String keyType)
  {
    ...
    //String beanPath = "model\\" + entityPackage + "\\" + className + ".java";
    //String mapperPath = "dao\\" + entityPackage + "\\" + className + "Dao.java";
    String servicePath = "service\\" + entityPackage + "\\" + className + "ServiceI.java";
    String controllerPath = "controller\\" + entityPackage + "\\" + className + "Controller.java";
    //String sqlMapperPath = "mapping\\" + entityPackage + "\\" + className + "Mapper.xml";
